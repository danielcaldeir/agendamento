                                                        ...
                                                        <table class="table table-hover">
                                                            ...
                                                            <tbody>
                                                                @foreach ($appointments as $appointment)
                                                                    {{ ( ($user->type === 'patient') ? $appointment->doctor : '' )  }}
                                                                    {{ ( ($user->type === 'doctor')  ? $appointment->patient : '' ) }}
                                                                    <!-- {{ ( $user->type === 'patient' ? $appointment->doctor : $appointment->patient ) }} -->
                                                                    <tr onclick=location.href='{{ route('appointments.show', $appointment->id) }}' style="cursor: pointer;">
                                                                        ...
                                                                        <td>
                                                                            <h6 class="m-0 text-c-{{ $appointment->color }}">{{ $appointment->presenter()->status() }}</h6>
                                                                        </td>
