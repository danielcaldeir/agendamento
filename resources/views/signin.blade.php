...
<head>
    ...
    <title>AgendamentoServicos | Login</title>
    ...
    {{-- <link rel="stylesheet" href="{{ asset('plugins/datta-able-dashboard/dist/assets/css/style.css') }}"> --}}
</head>
...
<body>
    <div class='content'>
        ...
        <!-- [ Pre-loader ] End -->
        @include('layouts.pageHeaderSign')
    ...
    <script src="{{ asset('plugins/feather/dist/feather.js') }}"></script>
